...
// DeepCopyInto supports using UDPRoute within kubernetes types, where deepcopy-gen is used.
func (in *UDPRoute) DeepCopyInto(out *UDPRoute) {
	p := proto.Clone(in).(*UDPRoute)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UDPRoute. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new UDPRoute. Required by controller-gen.
func (in *UDPRoute) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using L4UDPMatchAttributes within kubernetes types, where deepcopy-gen is used.
func (in *L4UDPMatchAttributes) DeepCopyInto(out *L4UDPMatchAttributes) {
	p := proto.Clone(in).(*L4UDPMatchAttributes)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new L4UDPMatchAttributes. Required by controller-gen.
func (in *L4UDPMatchAttributes) DeepCopy() *L4UDPMatchAttributes {
	if in == nil {
		return nil
	}
	out := new(L4UDPMatchAttributes)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new L4UDPMatchAttributes. Required by controller-gen.
func (in *L4UDPMatchAttributes) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
